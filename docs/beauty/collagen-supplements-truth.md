...
1. Stomach acid and pepsin fragment the collagen into smaller peptides
2. Pancreatic enzymes further break these into di- and tripeptides
3. These small peptides are absorbed in the small intestine
4. They enter the bloodstream as amino acids and small peptide fragments
...
<div class="verdict-box">
  <h4>The Evidence Summary</h4>
  <p><strong>For skin:</strong> Moderate evidence of modest benefits. Reasonable to try if you're interested.</p>
  <p style="margin-top: 0.5rem;"><strong>For hair:</strong> Insufficient evidence to recommend specifically for hair. Adequate protein from any source is likely equivalent.</p>
  <p style="margin-top: 0.5rem;"><strong>For nails:</strong> Preliminary positive evidence, but limited to one small study.</p>
</div>
